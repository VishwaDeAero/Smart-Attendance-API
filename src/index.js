...
const v1EnrolmentRouter = require('./routes/v1/enrolmentRouter');
const v1AnalyticsRouter = require('./routes/v1/analyticsRouter');
...
app.use("/api/v1/enrolments", v1EnrolmentRouter);
